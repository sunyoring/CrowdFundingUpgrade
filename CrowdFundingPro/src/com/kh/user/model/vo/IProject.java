...
public class IProject {
	...
	public IProject(int userNo, String emailId, String projectCode, String projectName, int amountGoal,
	...
	public String toString() {
		return "IProject [userNo=" + userNo + ", emailId=" + emailId + ", projectCode=" + projectCode + ", projectName="
